...
function Page() {
  ...
  if ((interaction == null ? void 0 : interaction.prompt) == "login") {
    return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("form", { autoComplete: "false", action: "/interaction/" + (interaction == null ? void 0 : interaction.uid) + "/login", method: "post", children: /* @__PURE__ */ jsxs("button", { type: "submit", className: "w-full bg-blue-500 hover:bg-blue-700 text-white text-center px-5 py-2.5 rounded-lg font-bold py-2 px-4 rounded", children: [
      /* @__PURE__ */ jsx("span", { className: "text-sm font-light text-center", children: "Authenticate with" }),
      /* @__PURE__ */ jsx("div", { className: " pt-1 items-center text-center justify-center" }),
      /* @__PURE__ */ jsxs("div", { className: "justify-center flex items-center text-2xl text-center font-semibold text-center", children: [
        /* @__PURE__ */ jsx("img", { className: "w-8 h-8 mr-2", src: "https://cdn.prod.website-files.com/61ce2e4bcaa2660da2bb419e/62e14973c65367120073a891_app-icon.webp", alt: "logo" }),
        "HashPack"
      ] })
    ] }) }) });
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-5", children: [
        ...
        /* @__PURE__ */ jsxs("ul", { children: [
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Wallet address" }),
            " (0.0.1337)"
          ] }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Display name" }) }),
          /* @__PURE__ */ jsxs("li", { className: "border rounded-md border-2 border-red-500 ", children: [
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: "KYC profile" }),
            ", which includes your:",
            /* @__PURE__ */ jsxs("ul", { className: "font-medium", children: [
              /* @__PURE__ */ jsx("li", { children: "Full name" }),
              /* @__PURE__ */ jsx("li", { children: "Date of birth" }),
              /* @__PURE__ */ jsx("li", { children: "Residential address" })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("form", { autoComplete: "false", action: "/interaction/" + (interaction == null ? void 0 : interaction.uid) + "/consent", method: "post", children: [
        /* @__PURE__ */ jsx("button", { type: "submit", className: "bg-green-700 hover:bg-green-800 mr-1 text-white text-center px-10 py-2.5 rounded-lg font-bold  rounded", children: "Approve" }),
        /* @__PURE__ */ jsx("button", { onClick: handleDeny, className: "bg-neutral-600 hover:bg-neutral-700 text-white text-center px-5 py-2.5 rounded-lg font-bold  rounded", children: "Deny" })
      ] }) })
    ] });
  }
  return /* @__PURE__ */ jsx("h1", { children: "Unhandled interaction prompt" });
}
...
const configValuesSerialized = {
  ...
  ["Page"]: {
    type: "standard",
    definedAtData: { "filePathToShowToUser": "/pages/interaction/@uid/+Page.tsx", "fileExportPathToShowToUser": [] },
    valueSerialized: {
      type: "plus-file",
  ...
  ["data"]: {
    type: "standard",
    definedAtData: { "filePathToShowToUser": "/pages/interaction/@uid/+data.ts", "fileExportPathToShowToUser": [] },
    valueSerialized: {
      type: "plus-file",
  ...
  ["title"]: {
    type: "standard",
    definedAtData: { "filePathToShowToUser": "/pages/interaction/@uid/+title.ts", "fileExportPathToShowToUser": [] },
    valueSerialized: {
      type: "plus-file",
