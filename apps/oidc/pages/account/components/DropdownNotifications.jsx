                        ...
                        <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
                            ...
                            >
                                <span className="block text-sm mb-2">
                                    📣 <span className="font-medium text-gray-800 dark:text-gray-100">You're in the alpha!</span> Thanks for
                                    testing out HashAuth. Click or tap the information icon to the right to learn more.
                                </span>
                                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">Dec 15, 2024</span>
                            </a>
                        </li>
                    </ul>
                </div>
