        ...
        <div className="min-w-fit">
            ...
            >
                ...
                <div className="flex justify-between mb-10 pr-3 sm:px-2">
                    ...
                    <h1 className="hidden 2xl:block text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                        <a href="/">
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-3">
                            {/* Dashboard */}
                            <li
                                className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] ${pathname == "/account" && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}
                            >
                                <a
                                    href="/account"
                                    onClick={() => {
                                    ...
                                    className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                                        pathname === "/" || pathname == "/account" ? "" : "hover:text-gray-600 dark:hover:text-white"
                                    }`}
                                >
                            ...
                            <li
                                className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] ${pathname == "/account/identity" && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}
                            >
                                <a
                                    ...
                                    className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                                        pathname === "/" || pathname == "/account/identity"
                                            ? ""
