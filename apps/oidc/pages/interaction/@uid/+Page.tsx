  ...
  if (interaction?.prompt == "login") {
    return (
      <div className="text-center">
        <form
          autoComplete="false"
          action={"/interaction/" + interaction?.uid + "/login"}
          method="post"
        >
          <button
            type="submit"
          ...
          <button
            ...
            className="w-10/12 bg-blue-500 hover:bg-blue-700 text-white text-center mt-1 rounded-lg font-bold py-1 px-4 rounded"
          >
            <span className="text-xs font-light text-center">
              Authenticate with
            </span>
    ...
    return (
      <div className="container prose dark:prose-invert">
        ...
        <div>
          <form
            autoComplete="false"
            action={"/interaction/" + interaction?.uid + "/confirm"}
            method="post"
          >
            <button
              type="submit"
